...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    "use strict";
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 35: (a, b) => {
      "use strict";
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let be = new TextEncoder(), bf = new TextDecoder();
      function bg(a10) {
        let b2 = new Uint8Array(a10.length);
      ...
      function bh(a10) {
        if (Uint8Array.fromBase64) return Uint8Array.fromBase64("string" == typeof a10 ? a10 : bf.decode(a10), { alphabet: "base64url" });
        let b2 = a10;
        b2 instanceof Uint8Array && (b2 = bf.decode(b2)), b2 = b2.replace(/-/g, "+").replace(/_/g, "/");
        try {
          var c2 = b2;
          if (Uint8Array.fromBase64) return Uint8Array.fromBase64(c2);
          let a11 = atob(c2), d2 = new Uint8Array(a11.length);
          for (let b3 = 0; b3 < a11.length; b3++) d2[b3] = a11.charCodeAt(b3);
          return d2;
        } catch {
      ...
      class bi extends Error {
        ...
        constructor(a10, b2) {
          super(a10, b2), this.name = this.constructor.name, Error.captureStackTrace?.(this, this.constructor);
        }
      }
      class bj extends bi {
        ...
        constructor(a10, b2, c2 = "unspecified", d2 = "unspecified") {
          super(a10, { cause: { claim: c2, reason: d2, payload: b2 } }), this.claim = c2, this.reason = d2, this.payload = b2;
        }
      }
      class bk extends bi {
      ...
      class bp extends bi {
        ...
        constructor(a10 = "multiple matching keys found in the JSON Web Key Set", b2) {
          super(a10, b2);
        }
      }
      class bq extends bi {
        ...
        constructor(a10 = "signature verification failed", b2) {
          super(a10, b2);
        }
      }
      let br = (a10, b2 = "algorithm.name") => TypeError(`CryptoKey does not support this operation, its ${b2} must be ${a10}`);
      function bs(a10, b2) {
        if (parseInt(a10.hash.name.slice(4), 10) !== b2) throw br(`SHA-${b2}`, "algorithm.hash");
      }
      ...
      let bu = (a10, b2, ...c2) => bt(`Key for the ${a10} algorithm must be `, b2, ...c2);
      async function bv(a10, b2, c2) {
        if (b2 instanceof Uint8Array) {
          if (!a10.startsWith("HS")) throw TypeError(((a11, ...b3) => bt("Key must be ", a11, ...b3))(b2, "CryptoKey", "KeyObject", "JSON Web Key"));
          return crypto.subtle.importKey("raw", b2, { hash: `SHA-${a10.slice(-3)}`, name: "HMAC" }, false, [c2]);
        }
        return !function(a11, b3, c3) {
          switch (b3) {
            case "HS256":
            case "HS384":
            case "HS512":
              if ("HMAC" !== a11.algorithm.name) throw br("HMAC");
              bs(a11.algorithm, parseInt(b3.slice(2), 10));
              break;
            case "RS256":
            case "RS384":
            case "RS512":
              if ("RSASSA-PKCS1-v1_5" !== a11.algorithm.name) throw br("RSASSA-PKCS1-v1_5");
              bs(a11.algorithm, parseInt(b3.slice(2), 10));
              break;
            case "PS256":
            case "PS384":
            case "PS512":
              if ("RSA-PSS" !== a11.algorithm.name) throw br("RSA-PSS");
              bs(a11.algorithm, parseInt(b3.slice(2), 10));
              break;
            case "Ed25519":
            case "EdDSA":
              if ("Ed25519" !== a11.algorithm.name) throw br("Ed25519");
              break;
            case "ML-DSA-44":
            case "ML-DSA-65":
            case "ML-DSA-87":
              let d2;
              if (d2 = a11.algorithm, d2.name !== b3) throw br(b3);
              break;
            case "ES256":
            case "ES384":
            case "ES512": {
              if ("ECDSA" !== a11.algorithm.name) throw br("ECDSA");
              let c4 = function(a12) {
                switch (a12) {
                  case "ES256":
                    return "P-256";
              ...
              if (a11.algorithm.namedCurve !== c4) throw br(c4, "algorithm.namedCurve");
              break;
            }
            default:
      ...
      async function bw(a10, b2, c2, d2) {
        let e2 = await bv(a10, b2, "verify");
        if (a10.startsWith("RS") || a10.startsWith("PS")) {
          let { modulusLength: b3 } = e2.algorithm;
          if ("number" != typeof b3 || b3 < 2048) throw TypeError(`${a10} requires key modulusLength to be 2048 bits or larger`);
        }
        let f2 = function(a11, b3) {
          ...
          switch (a11) {
            ...
            case "ES384":
            case "ES512":
              return { hash: c3, name: "ECDSA", namedCurve: b3.namedCurve };
            case "Ed25519":
            case "EdDSA":
              return { name: "Ed25519" };
            case "ML-DSA-44":
            ...
            case "ML-DSA-87":
              return { name: a11 };
            default:
              throw new bm(`alg ${a11} is not supported either by JOSE or your javascript runtime`);
          }
        }(a10, e2.algorithm);
        try {
      ...
      function bx(a10, b2, c2) {
        try {
          ...
          throw new c2(`Failed to base64url decode the ${b2}`);
        }
      }
      function by(a10) {
      ...
      Symbol();
      let bz = (a10) => by(a10) && "string" == typeof a10.kty, bA = (a10) => {
      ...
      }, bB = (a10) => a10?.[Symbol.toStringTag] === "KeyObject", bC = (a10) => bA(a10) || bB(a10), bD = (a10) => a10?.[Symbol.toStringTag], bE = (a10, b2, c2) => {
        if (void 0 !== b2.use) {
          let a11;
          switch (c2) {
            case "sign":
          ...
          if (b2.use !== a11) throw TypeError(`Invalid key for this operation, its "use" must be "${a11}" when present`);
        }
        if (void 0 !== b2.alg && b2.alg !== a10) throw TypeError(`Invalid key for this operation, its "alg" must be "${a10}" when present`);
        if (Array.isArray(b2.key_ops)) {
          let d2;
          switch (true) {
          ...
          if (d2 && b2.key_ops?.includes?.(d2) === false) throw TypeError(`Invalid key for this operation, its "key_ops" must include "${d2}" when present`);
        }
        return true;
      }, bF = 'Invalid or unsupported JWK "alg" (Algorithm) Parameter value';
          ...
          switch (a11.kty) {
            case "AKP":
              switch (a11.alg) {
                ...
                case "ML-DSA-65":
                case "ML-DSA-87":
                  b3 = { name: a11.alg }, c3 = a11.priv ? ["sign"] : ["verify"];
                  break;
                default:
                  throw new bm(bF);
              }
            ...
            case "EC":
              switch (a11.alg) {
                ...
                case "ES384":
                case "ES512":
                  b3 = { name: "ECDSA", namedCurve: { ES256: "P-256", ES384: "P-384", ES512: "P-521" }[a11.alg] }, c3 = a11.d ? ["sign"] : ["verify"];
                  break;
                case "ECDH-ES":
                case "ECDH-ES+A128KW":
                case "ECDH-ES+A192KW":
            ...
            case "OKP":
              switch (a11.alg) {
                case "Ed25519":
                case "EdDSA":
                  b3 = { name: "Ed25519" }, c3 = a11.d ? ["sign"] : ["verify"];
                  break;
                case "ECDH-ES":
                case "ECDH-ES+A128KW":
                case "ECDH-ES+A192KW":
              ...
              break;
            default:
              throw new bm('Invalid or unsupported JWK "kty" (Key Type) Parameter value');
          }
          return { algorithm: b3, keyUsages: c3 };
        }(a10), d2 = { ...a10 };
        return "AKP" !== d2.kty && delete d2.alg, delete d2.use, crypto.subtle.importKey("jwk", d2, b2, a10.ext ?? (!a10.d && !a10.priv), a10.key_ops ?? c2);
      }
      let bH = "given KeyObject instance cannot be used for this algorithm", bI = async (a10, b2, c2, d2 = false) => {
        let f2 = (e ||= /* @__PURE__ */ new WeakMap()).get(a10);
        if (f2?.[c2]) return f2[c2];
        let g2 = await bG({ ...b2, alg: c2 });
        return d2 && Object.freeze(a10), f2 ? f2[c2] = g2 : e.set(a10, { [c2]: g2 }), g2;
      };
      async function bJ(a10, b2) {
        if (a10 instanceof Uint8Array || bA(a10)) return a10;
        if (bB(a10)) {
          ...
          if ("toCryptoKey" in a10 && "function" == typeof a10.toCryptoKey) try {
            return ((a11, b3) => {
              ...
              if ("ed25519" === a11.asymmetricKeyType) {
                if ("EdDSA" !== b3 && "Ed25519" !== b3) throw TypeError(bH);
              ...
              switch (a11.asymmetricKeyType) {
                ...
                case "ml-dsa-65":
                case "ml-dsa-87":
                  if (b3 !== a11.asymmetricKeyType.toUpperCase()) throw TypeError(bH);
                  c3 = a11.toCryptoKey(a11.asymmetricKeyType, g2, [f2 ? "verify" : "sign"]);
              }
              if ("rsa" === a11.asymmetricKeyType) {
                ...
                if (b3.startsWith("RSA-OAEP")) return a11.toCryptoKey({ name: "RSA-OAEP", hash: d3 }, g2, f2 ? ["encrypt"] : ["decrypt"]);
                c3 = a11.toCryptoKey({ name: b3.startsWith("PS") ? "RSA-PSS" : "RSASSA-PKCS1-v1_5", hash: d3 }, g2, [f2 ? "verify" : "sign"]);
              }
              if ("ec" === a11.asymmetricKeyType) {
                ...
                if (!d3) throw TypeError(bH);
                let e2 = { ES256: "P-256", ES384: "P-384", ES512: "P-521" };
                e2[b3] && d3 === e2[b3] && (c3 = a11.toCryptoKey({ name: "ECDSA", namedCurve: d3 }, g2, [f2 ? "verify" : "sign"])), b3.startsWith("ECDH-ES") && (c3 = a11.toCryptoKey({ name: "ECDH", namedCurve: d3 }, g2, f2 ? [] : ["deriveBits"]));
              }
              if (!c3) throw TypeError(bH);
              return d2 ? d2[b3] = c3 : e.set(a11, { [b3]: c3 }), c3;
            })(a10, b2);
          } catch (a11) {
        ...
        if (bz(a10)) return a10.k ? bh(a10.k) : bI(a10, a10, b2, true);
        throw Error("unreachable");
      }
      async function bK(a10, b2, c2) {
        if (!by(a10)) throw new bn("Flattened JWS must be an object");
        if (void 0 === a10.protected && void 0 === a10.header) throw new bn('Flattened JWS must have either of the "protected" or "header" members');
        if (void 0 !== a10.protected && "string" != typeof a10.protected) throw new bn("JWS Protected Header incorrect type");
        if (void 0 === a10.payload) throw new bn("JWS Payload missing");
        if ("string" != typeof a10.signature) throw new bn("JWS Signature missing or incorrect type");
        if (void 0 !== a10.header && !by(a10.header)) throw new bn("JWS Unprotected Header incorrect type");
        let d2 = {};
        if (a10.protected) try {
          let b3 = bh(a10.protected);
          d2 = JSON.parse(bf.decode(b3));
        } catch {
          throw new bn("JWS Protected Header is invalid");
        }
        if (!function(...a11) {
          let b3, c3 = a11.filter(Boolean);
          ...
          for (let a12 of c3) {
            ...
            for (let a13 of c4) {
              if (b3.has(a13)) return false;
              b3.add(a13);
            }
          }
          return true;
        }(d2, a10.header)) throw new bn("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
        let e2 = { ...d2, ...a10.header }, f2 = function(a11, b3, c3, d3, e3) {
          let f3;
          ...
          for (let g3 of (f3 = void 0 !== c3 ? new Map([...Object.entries(c3), ...b3.entries()]) : b3, d3.crit)) {
            if (!f3.has(g3)) throw new bm(`Extension Header Parameter "${g3}" is not recognized`);
        ...
        }(bn, /* @__PURE__ */ new Map([["b64", true]]), c2?.crit, d2, e2), g2 = true;
        if (f2.has("b64") && "boolean" != typeof (g2 = d2.b64)) throw new bn('The "b64" (base64url-encode payload) Header Parameter must be a boolean');
        let { alg: h2 } = e2;
        if ("string" != typeof h2 || !h2) throw new bn('JWS "alg" (Algorithm) Header Parameter missing or invalid');
        let i2 = c2 && function(a11, b3) {
          if (void 0 !== b3 && (!Array.isArray(b3) || b3.some((a12) => "string" != typeof a12))) throw TypeError(`"${a11}" option must be an array of strings`);
          if (b3) return new Set(b3);
        }("algorithms", c2.algorithms);
        if (i2 && !i2.has(h2)) throw new bl('"alg" (Algorithm) Header Parameter value not allowed');
        if (g2) {
          if ("string" != typeof a10.payload) throw new bn("JWS Payload must be a string");
        } else if ("string" != typeof a10.payload && !(a10.payload instanceof Uint8Array)) throw new bn("JWS Payload must be a string or an Uint8Array instance");
        let j2 = false;
        "function" == typeof b2 && (b2 = await b2(d2, a10), j2 = true);
        var k2 = b2, l2 = "verify";
          ...
          case "PB":
            ((a11, b3, c3) => {
              if (!(b3 instanceof Uint8Array)) {
                if (bz(b3)) {
                  let d3;
                  if ("oct" === (d3 = b3).kty && "string" == typeof d3.k && bE(a11, b3, c3)) return;
                ...
                if (!bC(b3)) throw TypeError(bu(a11, b3, "CryptoKey", "KeyObject", "JSON Web Key", "Uint8Array"));
                if ("secret" !== b3.type) throw TypeError(`${bD(b3)} instances for symmetric algorithms must be of type "secret"`);
              }
            })(h2, k2, l2);
            break;
          default:
            ((a11, b3, c3) => {
              if (bz(b3)) switch (c3) {
                ...
                case "sign":
                  let d3;
                  if ("oct" !== (d3 = b3).kty && ("AKP" === d3.kty && "string" == typeof d3.priv || "string" == typeof d3.d) && bE(a11, b3, c3)) return;
                  throw TypeError("JSON Web Key for this operation must be a private JWK");
                case "encrypt":
                case "verify":
                  let e3;
                  if ("oct" !== (e3 = b3).kty && void 0 === e3.d && void 0 === e3.priv && bE(a11, b3, c3)) return;
                  throw TypeError("JSON Web Key for this operation must be a public JWK");
              }
              if (!bC(b3)) throw TypeError(bu(a11, b3, "CryptoKey", "KeyObject", "JSON Web Key"));
              if ("secret" === b3.type) throw TypeError(`${bD(b3)} instances for asymmetric algorithms must not be of type "secret"`);
              if ("public" === b3.type) switch (c3) {
                case "sign":
                  throw TypeError(`${bD(b3)} instances for asymmetric algorithm signing must be of type "private"`);
                case "decrypt":
                  throw TypeError(`${bD(b3)} instances for asymmetric algorithm decryption must be of type "private"`);
              }
              if ("private" === b3.type) switch (c3) {
                case "verify":
                  throw TypeError(`${bD(b3)} instances for asymmetric algorithm verifying must be of type "public"`);
                case "encrypt":
                  throw TypeError(`${bD(b3)} instances for asymmetric algorithm encryption must be of type "public"`);
              }
            })(h2, k2, l2);
        }
        let m2 = function(...a11) {
          let b3 = new Uint8Array(a11.reduce((a12, { length: b4 }) => a12 + b4, 0)), c3 = 0;
          for (let d3 of a11) b3.set(d3, c3), c3 += d3.length;
          return b3;
        }(void 0 !== a10.protected ? bg(a10.protected) : new Uint8Array(), bg("."), "string" == typeof a10.payload ? g2 ? bg(a10.payload) : be.encode(a10.payload) : a10.payload), n2 = bx(a10.signature, "signature", bn), o2 = await bJ(b2, h2);
        if (!await bw(h2, o2, n2, m2)) throw new bq();
        let p2 = { payload: g2 ? bx(a10.payload, "payload", bn) : "string" == typeof a10.payload ? be.encode(a10.payload) : a10.payload };
        return (void 0 !== a10.protected && (p2.protectedHeader = d2), void 0 !== a10.header && (p2.unprotectedHeader = a10.header), j2) ? { ...p2, key: o2 } : p2;
      }
      async function bL(a10, b2, c2) {
        if (a10 instanceof Uint8Array && (a10 = bf.decode(a10)), "string" != typeof a10) throw new bn("Compact JWS must be a string or Uint8Array");
        let { 0: d2, 1: e2, 2: f2, length: g2 } = a10.split(".");
        if (3 !== g2) throw new bn("Invalid Compact JWS");
        let h2 = await bK({ payload: e2, protected: d2, signature: f2 }, b2, c2), i2 = { payload: h2.payload, protectedHeader: h2.protectedHeader };
        return "function" == typeof b2 ? { ...i2, key: h2.key } : i2;
      }
      let bM = /^(\+|\-)? ?(\d+|\d+\.\d+) ?(seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)(?: (ago|from now))?$/i;
      function bN(a10) {
        let b2, c2 = bM.exec(a10);
      ...
      let bO = (a10) => a10.includes("/") ? a10.toLowerCase() : `application/${a10.toLowerCase()}`;
      async function bP(a10, b2, c2) {
        let d2 = await bL(a10, b2, c2);
        if (d2.protectedHeader.crit?.includes("b64") && false === d2.protectedHeader.b64) throw new bo("JWTs MUST NOT use unencoded payload");
        let e2 = { payload: function(a11, b3, c3 = {}) {
          var d3, e3;
          let f2, g2;
          try {
            f2 = JSON.parse(bf.decode(b3));
          } catch {
          }
          if (!by(f2)) throw new bo("JWT Claims Set must be a top-level JSON object");
          let { typ: h2 } = c3;
          if (h2 && ("string" != typeof a11.typ || bO(a11.typ) !== bO(h2))) throw new bj('unexpected "typ" JWT header value', f2, "typ", "check_failed");
          let { requiredClaims: i2 = [], issuer: j2, subject: k2, audience: l2, maxTokenAge: m2 } = c3, n2 = [...i2];
          for (let a12 of (void 0 !== m2 && n2.push("iat"), void 0 !== l2 && n2.push("aud"), void 0 !== k2 && n2.push("sub"), void 0 !== j2 && n2.push("iss"), new Set(n2.reverse()))) if (!(a12 in f2)) throw new bj(`missing required "${a12}" claim`, f2, a12, "missing");
          if (j2 && !(Array.isArray(j2) ? j2 : [j2]).includes(f2.iss)) throw new bj('unexpected "iss" claim value', f2, "iss", "check_failed");
          if (k2 && f2.sub !== k2) throw new bj('unexpected "sub" claim value', f2, "sub", "check_failed");
          if (l2 && (d3 = f2.aud, e3 = "string" == typeof l2 ? [l2] : l2, "string" == typeof d3 ? !e3.includes(d3) : !(Array.isArray(d3) && e3.some(Set.prototype.has.bind(new Set(d3)))))) throw new bj('unexpected "aud" claim value', f2, "aud", "check_failed");
          switch (typeof c3.clockTolerance) {
            case "string":
              g2 = bN(c3.clockTolerance);
              break;
            case "number":
          ...
          if ((void 0 !== f2.iat || m2) && "number" != typeof f2.iat) throw new bj('"iat" claim must be a number', f2, "iat", "invalid");
          if (void 0 !== f2.nbf) {
            if ("number" != typeof f2.nbf) throw new bj('"nbf" claim must be a number', f2, "nbf", "invalid");
            if (f2.nbf > p2 + g2) throw new bj('"nbf" claim timestamp check failed', f2, "nbf", "check_failed");
          }
          if (void 0 !== f2.exp) {
            if ("number" != typeof f2.exp) throw new bj('"exp" claim must be a number', f2, "exp", "invalid");
            if (f2.exp <= p2 - g2) throw new bk('"exp" claim timestamp check failed', f2, "exp", "check_failed");
          }
          if (m2) {
            let a12 = p2 - f2.iat;
            if (a12 - g2 > ("number" == typeof m2 ? m2 : bN(m2))) throw new bk('"iat" claim timestamp check failed (too far in the past)', f2, "iat", "check_failed");
            if (a12 < 0 - g2) throw new bj('"iat" claim timestamp check failed (it should be in the past)', f2, "iat", "check_failed");
          }
          return f2;
        }(d2.protectedHeader, d2.payload, c2), protectedHeader: d2.protectedHeader };
        return "function" == typeof b2 ? { ...e2, key: d2.key } : e2;
      }
      let bQ = new TextEncoder().encode(process.env.JWT_SECRET || "llm-compare-dev-secret-change-in-production-7f8a9b2c3d4e5f6a");
      async function bR(a10) {
        try {
          let { payload: b2 } = await bP(a10, bQ);
          return { sub: b2.sub, iat: b2.iat, exp: b2.exp };
        } catch {
          return null;
        }
      }
      async function bS(a10) {
        let { pathname: b2 } = a10.nextUrl, c2 = a10.cookies.get("llm_session")?.value, d2 = c2 ? await bR(c2) : null;
        if (["/api/favorites", "/api/comparisons", "/api/activity", "/api/auth/logout", "/api/auth/profile", "/api/auth/password", "/api/auth/account", "/profile"].some((a11) => b2 === a11 || b2.startsWith(a11 + "/")) && !d2) {
          if (b2.startsWith("/api/")) return S.json({ error: "Unauthorized" }, { status: 401 });
          let c3 = a10.nextUrl.clone();
          return c3.pathname = "/login", c3.searchParams.set("redirect", b2), S.redirect(c3);
        }
        return S.next();
      }
      let bT = { matcher: ["/((?!_next/static|_next/image|favicon.ico).*)"] };
      ...
      function bX(a10) {
        return bc({ ...a10, page: bW, handler: async (...a11) => {
          try {
            return await bV(...a11);
          } catch (e2) {
